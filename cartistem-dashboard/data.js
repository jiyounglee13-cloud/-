...
window.CARTISTEM_META = {
  ...
  synthesis: [
    "다기관 무작위 대조 3상 시험(Lim 2021, n=114)에서 hUCB-MSC-HA군의 48주 2차 관절경상 ICRS 1등급 이상 개선률은 97.7%로 미세골절군 71.7%보다 유의하게 높았다(P=.001). 통증·기능 지표는 48주에는 군간 차이가 없었으나 3~5년 추적에서 hUCB-MSC-HA군이 유의하게 우수하였다(P<.05).",
    "최초 인체적용 연구(Park 2017, n=7, 7년 추적)와 5.5년 추적 증례에서 골형성·종양화는 관찰되지 않았고, 조직학상 유리연골 유사 조직 재생이 확인되었다.",
    "고위경골절골술(HTO) 병용 연구(Seon·Song·Park·Kim 등)에서 IKDC·WOMAC·VAS가 일관되게 유의하게 개선되었다. Int Orthop 2021(n=93)에서 IKDC 중앙값 39.0→71.3, WOMAC 44.5→11.0으로 호전되었고, 2차 관절경상 수술 전 전례 ICRS IV였던 병변의 등급이 향상되었다.",
    "골수흡인농축물(BMAC)과의 직접 비교(Cell Transplantation 2020, Arthroscopy 2021, KSSTA 2022, 메타분석 2023)에서 임상결과는 양 군이 대등하였으나(메타분석 IKDC SMD 3.92 vs 4.13, p=0.91), 2차 관절경상 재생 연골 등급은 hUCB-MSC군이 반복적으로 우수하였다(KSSTA 2022 p=0.040, 메타분석 p<0.001).",
    "미세천공·미세골절과의 비교에서 hUCB-MSC군이 우수하였다. Scientific Reports 2024에서 24개월 VAS 15.21 vs 28.57(P=0.016), IKDC 58.54 vs 50.29(P=0.038)였고, KSSTA 2024에서 유리연골형 지표인 제2형 콜라겐 양성률이 93.3% vs 60%(p=0.041)로 높았다.",
    "비용효과 분석(2023)에서 미세골절 대비 ICER은 US$16,812/QALY(보건의료체계 관점)로, 비용효과적 치료로 평가되었다.",
    "다수 연구가 후향적 설계·적은 표본 수·대조군 부재의 제한점을 공유하며, 저자들은 공통적으로 대규모 무작위 대조연구와 장기 추적의 필요성을 지적하였다."
  ]
};
...
window.PAPERS = [
  /* ===================== 1. CARTISTEM Phase 3 RCT ===================== */
  {
    ...
    design: "다기관 무작위 대조 3상 시험 + 5년 관찰 연장 추적", evidenceLabel: "무작위 대조시험",
    ...
    tableC: [
      { v: "평균 결손 크기", r: "4.9 cm²", c: "4.0 cm²", e: "유사(군간 차이 없음)", s: "P=.051" },
      { v: "48주 ICRS 1등급 이상 개선 비율(1차)", r: "97.7%", c: "71.7%", e: "군간 차이", s: "P=.001" },
      { v: "전체 조직학적 평가 점수", r: "더 우수", c: "기준(미세골절)", e: "hUCB-MSC군 우월", s: "P=.036" },
      { v: "VAS·WOMAC·IKDC (48주)", r: "개선", c: "개선", e: "군간 유의차 없음", s: "P>.05" },
      { v: "VAS·WOMAC·IKDC (3~5년)", r: "유의하게 양호", c: "기준", e: "군간 차이", s: "P<.05" },
      { v: "이상반응", r: "양군 유사", c: "양군 유사", e: "군간 차이 없음", s: "안전성 동등" }
    ],
    tableD: [
      { m: "hUCB-MSC-HA군은 48주 2차 관절경 및 조직학상 연골 회복이 미세골절군보다 우수하였다.", b: "표 C: 48주 1등급 개선 97.7% vs 71.7%(P=.001), 조직학 P=.036" },
      { m: "통증·기능 지표는 48주에는 군간 차이가 없었으나 3~5년 추적에서 hUCB-MSC-HA군이 유의하게 우수하였다.", b: "표 C: 3~5년 임상지표 P<.05" },
      { m: "10개 기관 114명을 무작위 배정한 다기관 무작위 대조연구로, 미세골절과의 직접 비교 근거를 제공한다.", b: "표 B: RCT, 10개 병원, 114명 무작위 배정" }
    ],
    tableE: [
      { l: "개방표지(open-label) 설계 — UCB-MSC군은 관절절개, 미세골절군은 관절경으로 이중맹검 불가", i: "수행·평가 편향 가능(단, 1차 평가는 맹검)", f: "보다 엄격한 대조 설계(예: 개방 미세골절 대조)가 바람직하나 규제·연구진 합의로 채택되지 않았다." },
  ...
  /* ===================== 2. Stem Cells Transl Med (first-in-human, 7yr) ===================== */
  {
    ...
    tableC: [
      { v: "12주 관절경 소견(1차)", r: "성숙 중인 재생 조직 관찰", c: "—(단일군)", e: "—", s: "관찰 소견" },
      { v: "VAS·IKDC", r: "24주에 개선, 7년간 안정 유지", c: "—", e: "—", s: "원문 미보고(p값)" },
      { v: "1년 조직학", r: "유리연골 유사(hyaline-like) 연골", c: "—", e: "—", s: "관찰 소견" },
      { v: "3년 MRI", r: "재생 연골 지속", c: "—", e: "—", s: "관찰 소견" },
    ...
    tableD: [
      ...
      { m: "12주 재생 조직, 1년 조직학상 유리연골 유사 연골, 3년 MRI상 유지가 확인되어 재생 조직의 내구성이 뒷받침되었다.", b: "표 C: 12주 관절경·1년 조직·3년 MRI 소견" },
      { m: "단일군 7례의 초기 임상연구로, 효능은 개념증명 수준이다.", b: "표 E: 적은 표본 수와 대조군 부재" }
    ],
    tableE: [
  ...
  /* ===================== 3. BMC Musculoskeletal Disorders — case report 5yr ===================== */
  {
    ...
    tableC: [
      { v: "12개월 통증·기능", r: "유의 개선", c: "—(단일 증례)", e: "—", s: "관찰 소견" },
      { v: "결손 충전(MRI·2차 관절경·조직)", r: "유리연골 유사 연골이 완전 충전, 주변 정상 연골과 일치", c: "—", e: "—", s: "관찰 소견" },
      { v: "장기 유지", r: "임상 개선 5.5년까지 유지, 골·연골 조직 유지(MRI)", c: "—", e: "—", s: "관찰 소견" }
    ],
    tableD: [
      { m: "동종 UCB-MSC-HA 복합체로 대형 골연골 결손에서 연골과 연골하골이 함께 재건되었다.", b: "표 C: 유리연골 유사 조직 완전 충전, 골·연골 유지" },
      { m: "임상·영상 개선이 5.5년까지 유지되어 재생 조직의 내구성이 확인되었다.", b: "표 C: 5.5년 유지" },
      { m: "단일 증례로 일반화에는 제한이 있다.", b: "표 B: n=1 증례 보고" }
    ],
    tableE: [
  ...
  /* ===================== 4. The Knee 2019 — DFO + hUCB-MSC (2 cases) ===================== */
  {
    ...
    tableC: [
      { v: "IKDC·VAS·WOMAC", r: "수술 후 지속 개선", c: "—(2례)", e: "—", s: "관찰 소견" },
      { v: "2차 관절경 ICRS", r: "두 환자 모두 grade 1(정상에 가까움)", c: "—", e: "—", s: "관찰 소견" },
      { v: "수정 2D MOCART", r: "두 사례 모두 시간에 따라 증가", c: "—", e: "—", s: "관찰 소견" }
    ],
    tableD: [
      { m: "외측 구획 골관절염에 대해 hUCB-MSC와 원위대퇴골절골술(DFO)을 병용한 첫 증례 보고이다.", b: "표 B/C: 첫 보고, ICRS grade 1 재생" },
      { m: "관절보존술과 병용 시 임상·영상 지표가 모두 호전되었다.", b: "표 C: IKDC·VAS·WOMAC·MOCART 개선" },
      { m: "2례에 국한된 예비적 결과이다.", b: "표 B: n=2 증례 보고" }
    ],
    tableE: [
  ...
  /* ===================== 5. World J Stem Cells 2020 — HTO + hUCB-MSC n=125 ===================== */
  {
    ...
    design: "후향적 연구(증례 시리즈), 대조군 없음", evidenceLabel: "후향적 증례 시리즈",
    ...
    tableB: {
      ...
      followup: "2차 관절경 시점까지"
    },
    tableC: [
      { v: "2차 관절경 MFC ICRS grade I", r: "73명 (58.4%)", c: "—(단일군)", e: "—", s: "—" },
      { v: "ICRS grade II / III", r: "37명(29.6%) / 15명(12%)", c: "—", e: "grade IV 0명", s: "—" },
      { v: "임상 점수(ICRS I군 vs II·III군)", r: "ICRS grade I군이 더 크게 개선(1년 IKDC 제외)", c: "—", e: "연골 재생 양호할수록 임상 우수", s: "유의함" }
    ],
    tableD: [
      { m: "내반변형을 동반한 내측 구획 골관절염에서 HTO와 hUCB-MSC 이식은 유효하였으며, 연골 재생 정도가 임상 개선과 연관되었다.", b: "표 C: 2차 관절경 87.6%가 ICRS I·II, grade IV 0명" },
      { m: "재생 연골 등급이 양호할수록(ICRS I) 임상결과가 우수하였다.", b: "표 C: ICRS I군의 우월한 개선" },
      { m: "대조군이 없는 후향적 연구로 비교 효능은 입증되지 않았다.", b: "표 E: 후향, 대조군 없음" }
    ],
    tableE: [
      { l: "후향적이며 대조군 미포함", i: "비교 효능 입증 제한", f: "125례 전원에서 2차 관절경으로 재생을 확인하였으며, 연골재생술의 필요성을 뒷받침한다." }
    ]
  },
  ...
  /* ===================== 6. Regenerative Therapy 2020 — n=128 2yr ===================== */
  {
    ...
    design: "증례 시리즈(후향), 대조군 없음", evidenceLabel: "후향적 증례 시리즈",
    pmid: "31988992", reg: "—", impact: "IF 1.420",
    tableB: {
      question: "골관절염에서 hUCB-MSC 이식 후 임상결과 및 병변 특성(위치·크기)에 따른 결과 차이",
    ...
    tableC: [
      { v: "VAS 통증(수술 전→최종)", r: "7.0 → 2.0", c: "—(단일군, 수술 전 대비)", e: "5.0점 감소", s: "P<0.001" },
      { v: "WOMAC(수술 전→최종)", r: "39.3 → 13.9", c: "—", e: "25.4점 감소", s: "P<0.001" },
      { v: "IKDC(수술 전→최종)", r: "32.5 → 61.2", c: "—", e: "28.7점 상승", s: "P<0.001" },
      { v: "병변 위치 영향", r: "MFC 병변이 LFC·활차 병변보다 결과 불량", c: "—", e: "위치 간 차이", s: "P<0.05" },
      { v: "이상반응/합병증", r: "관찰되지 않음", c: "—", e: "—", s: "안전성" }
    ],
    tableD: [
      { m: "hUCB-MSC 이식 후 2년간 통증·기능(VAS·WOMAC·IKDC)이 유의하게 개선되었다.", b: "표 C: VAS·WOMAC·IKDC P<0.001" },
      { m: "병변 위치가 결과에 영향을 미쳐, 내측 대퇴과(MFC) 병변의 예후가 상대적으로 불량하였다.", b: "표 C: 위치 효과 P<0.05" },
      { m: "후향적 설계와 대조군 부재로 비교 효능 판단에는 제한이 있다.", b: "표 E: 후향 증례 시리즈" }
    ],
    tableE: [
  ...
  /* ===================== 7. Arch Orthop Trauma Surg 2020 — >60yr n=25 ===================== */
  {
    ...
    design: "증례 시리즈(후향)", evidenceLabel: "후향적 증례 시리즈",
    ...
    tableC: [
      { v: "IKDC·VAS·WOMAC (수술 전→1·2년)", r: "수술 전 대비 유의 개선", c: "—(단일군)", e: "통증·기능 개선", s: "유의함" },
      { v: "연령 효과(<65 vs ≥65세)", r: "<65세군이 IKDC(1·2년)·VAS(2년) 우월", c: "≥65세군", e: "<65세군이 더 양호", s: "유의함" },
      { v: "2차 관절경 ICRS-CRA(14명)", r: "grade I 6명(42.9%), grade II 8명(57.1%)", c: "—", e: "—", s: "—" }
    ],
    tableD: [
      { m: "60세 이상 내측 구획 골관절염에서 hUCB-MSC 이식과 HTO 병용으로 만족스러운 연골 재생과 임상결과를 얻었다.", b: "표 C: 임상지표 유의 개선, ICRS-CRA I·II 100%" },
      { m: "연령이 낮고 결손이 클수록 개선 폭이 컸다.", b: "표 C: <65세군 우월, 큰 결손 연관" },
      { m: "대조군이 없어 미세골절 대비 우월성은 입증되지 않았다.", b: "표 E: 대조군 없음" }
    ],
    tableE: [
  ...
  /* ===================== 8. J Clin Orthop Trauma 2019 — juvenile OCD (2 cases) ===================== */
  {
    ...
    tableC: [
      { v: "IKDC·VAS·Tegner", r: "두 환자 모두 우수한 개선", c: "—(2례)", e: "—", s: "관찰 소견" },
      { v: "2차 관절경 ICRS", r: "정상에 유사한 grade 1 연골 재생", c: "—", e: "—", s: "관찰 소견" },
      { v: "수정 2D MOCART", r: "두 사례 모두 시간에 따라 증가", c: "—", e: "—", s: "관찰 소견" }
    ],
    tableD: [
      { m: "소아 박리성 골연골염을 hUCB-MSC로 치료한 첫 증례 시리즈이다.", b: "표 B/C: 첫 보고, ICRS grade 1 재생" },
      { m: "IKDC·VAS·Tegner 및 MOCART 지표가 모두 호전되었다.", b: "표 C: 임상·MOCART 개선" },
      { m: "2례에 국한된 예비적 결과이다.", b: "표 B: n=2" }
    ],
    tableE: [
  ...
  /* ===================== 9 & 12. Int Orthop 2021 — HTO + hUCB-MSC n=93 ===================== */
  {
    ...
    tableC: [
      { v: "IKDC subjective(중앙값)", r: "39.0 → 71.3", c: "—(단일군, 수술 전 대비)", e: "+32.3점 개선", s: "p<0.05" },
      { v: "WOMAC(중앙값)", r: "44.5 → 11.0", c: "—", e: "33.5점 감소(개선)", s: "p<0.05" },
      { v: "KSS 통증 / 기능", r: "29.8→43.2 / 61.0→81.2", c: "—", e: "통증·기능 개선", s: "p<0.05" },
      { v: "HSS", r: "61.6 → 82.7", c: "—", e: "+21.1점 개선", s: "p<0.05" },
      { v: "2차 관절경 ICRS-CRA(49명)", r: "grade I 8.2%, II 69.3%, III 22.5%", c: "수술 전 모든 증례에서 grade IV", e: "전 증례 등급 호전", s: "p<0.05" },
      { v: "Koshino 단계", r: "B 24.5%, C 75.5%", c: "—", e: "재생 진행 단계", s: "p<0.05" }
    ],
    tableD: [
      { m: "내측 구획 골관절염에서 HTO와 hUCB-MSC 병용은 안전하였고 연골 상태의 개선이 확인되었다.", b: "표 C: IKDC·WOMAC·KSS·HSS 유의 개선(p<0.05)" },
      { m: "2차 관절경상 수술 전 전례 ICRS IV였던 병변의 등급이 향상되었다.", b: "표 C: ICRS-CRA I~III로 호전" },
      { m: "대조군이 없어 실제 효과와 적응증은 무작위 대조연구로 확인이 필요하다.", b: "표 E: 대조군 없음, 추적 짧음" }
    ],
    tableE: [
  ...
  /* ===================== 10. Cell Transplantation 2020 — BMAC vs hUCB-MSC ===================== */
  {
    ...
    tableC: [
      ...
      { v: "M-MOCART (1년 / 2년)", r: "양군 유사", c: "양군 유사", e: "군간 차이 없음", s: "P=0.261 / P=0.351" },
      { v: "ICRS 연골회복 점수", r: "양군 유사", c: "양군 유사", e: "군간 차이 없음", s: "P=0.655" }
    ],
    tableD: [
      { m: "BMAC군과 hUCB-MSC군 모두 2년 시점 임상·MRI 결과가 만족스러웠다.", b: "표 C: 양군 VAS·IKDC·KOOS 유의 개선(P<0.05)" },
      { m: "두 세포원 간 임상·영상 결과에 유의한 차이는 없었다.", b: "표 C: M-MOCART P=0.261/0.351, ICRS P=0.655" },
      { m: "적은 표본 수와 후향적 설계로 대규모 장기 추적이 필요하다.", b: "표 E: 적은 표본 수, 후향" }
    ],
    tableE: [
  ...
  /* ===================== 11. Arthroscopy 2021 — BMAC vs hUCB-MSC HTO+MFX ===================== */
  {
    ...
    tableC: [
      ...
      { v: "2차 관절경 ICRS 등급(MFC·MTC)", r: "더 양호", c: "기준(BMAC)", e: "hUCB-MSC 우월", s: "P=.001(양 부위)" },
      { v: "평균 ICRS 등급 변화", r: "3.9 → 2.0 (hUCB-MSC)", c: "3.9 → 2.8 (BMAC)", e: "hUCB-MSC가 더 큰 호전", s: "군간 P=.001" },
      { v: "방사선(HKA·후방경사·교정각)", r: "—", c: "—", e: "군간 차이 없음", s: "P>.05" }
    ],
    tableD: [
      { m: "임상결과는 BMAC군과 hUCB-MSC군이 대등하였으나, 2차 관절경상 연골 재생은 hUCB-MSC군이 우수하였다.", b: "표 C: 2차 관절경 ICRS P=.001, 임상 P>.05" },
      { m: "방사선상 교정량은 연골 재생 결과에 영향을 주지 않았다.", b: "표 C: 방사선 지표 군간 P>.05" },
      { m: "적은 표본 수와 후향적 설계가 제한점이다.", b: "표 E: 적은 표본 수, 후향" }
    ],
    tableE: [
  ...
  /* ===================== 13. KSSTA 2022 — BMAC vs hUCB-MSC PS-matched ===================== */
  {
    ...
    tableC: [
      { v: "IKDC(수술 전→최종)", r: "35.4 → 73.3 (hUCB-MSC)", c: "36.2 → 72.8 (BMAC)", e: "군간 차이 없음", s: "군내 p<0.001 · 군간 p=0.092" },
      { v: "Tegner 활동도(수술 전→최종)", r: "2.2 → 4.1 (hUCB-MSC)", c: "2.3 → 4.0 (BMAC)", e: "군간 차이 없음", s: "군내 p<0.001" },
      { v: "KOOS·SF-36(군내 개선)", r: "유의 개선(hUCB-MSC)", c: "유의 개선(BMAC)", e: "군간 차이 없음", s: "군내 p<0.001" },
    ...
    tableD: [
      { m: "임상결과는 두 세포원이 대등하였으나, 재생 연골 등급은 hUCB-MSC군이 BMAC군보다 우수하였다.", b: "표 C: ICRS-CRA p=0.040, 임상 군간 차이 없음" },
      { m: "재생 연골 등급이 높을수록 임상결과가 양호하여, 연골 재생의 임상적 의의가 뒷받침되었다.", b: "표 C: ICRS-CRA–임상 r=−0.337, p=0.002" },
      { m: "단일기관 후향 연구로, 성향점수 매칭 후에도 잔여 교란 가능성이 있다.", b: "표 E: 단일기관 후향, 미매칭 변수" }
    ],
    tableE: [
  ...
  /* ===================== 14. Arthroscopy Techniques 2021 — dry arthroscopy technique ===================== */
  {
    ...
    tableD: [
      { m: "특수 장비 없이 통상 관절경 기구만으로 건식 관절경하 hUCB-MSC 이식이 가능하였다.", b: "표 B: 단순 견인 술기" },
      { m: "관절경적 접근은 개방 관절절개에 비해 조기 관절 가동과 반흔 감소의 이점이 있다.", b: "본문: 관절경의 회복·반흔 이점" },
      { m: "추가 내측 작업 포털이 필요하며, 정량적 효능은 제시되지 않았다.", b: "표 E: 포털 추가, 술기 노트" }
    ],
    tableE: [
      { l: "추가 far-medial 작업 포털 필요", i: "술기 복잡성 증가", f: "본 술기를 적용한 증례 시리즈가 없어 추가 보고가 필요하다." }
    ]
  },
  ...
  /* ===================== 15. J Cartilage Joint Preservation 2022 — US phase 1/2a ===================== */
  {
    ...
    tableC: [
      ...
      { v: "IKDC 등 기능·통증", r: "기저 대비 12·24개월 유의 개선", c: "—", e: "기능·통증 개선", s: "유의함" },
      { v: "임상적 유의 MRI 이상", r: "기저 91.7%(n=11) → 24개월 16.7%(n=2)", c: "—", e: "—", s: "—" }
    ],
    tableD: [
      { m: "미국인 ICRS 3~4 환자에서 hUCB-MSC-4%HA 복합체 이식은 24개월간 안전하였다.", b: "표 C: 중대한 이상반응·사망·DLT 0건, MTD 2.0×10⁷" },
      { m: "기능·통증이 개선되고 MRI 이상 소견이 감소하여 연골 회복 소견이 확인되었다.", b: "표 C: IKDC 12·24개월 유의 개선, MRI 이상 91.7→16.7%" },
      { m: "적은 표본 수·개방표지·대조군 부재로 효능은 예비적이다.", b: "표 E: 1·2상의 본질적 한계" }
    ],
    tableE: [
      { l: "적은 표본 수, 개방표지 설계, 대조군 부재(1·2상 시험의 특성)", i: "효능 결과는 예비적", f: "한국 3상 자료와 유사한 이점을 보여, 추가 검증의 근거가 된다." }
    ]
  },
  ...
  /* ===================== 16. The Knee 2021 — hUCB-MSC+HTO vs MFx+HTO ===================== */
  {
    ...
    tableD: [
      { m: "HTO에서 hUCB-MSC 연골재생술은 미세골절 단독보다 IKDC와 관절간격(JSW) 개선이 우수하였다.", b: "표 C: IKDC 69 vs 62, JSW 0.6 vs 0.1 mm(P<0.05)" },
      { m: "대조군을 둔 비교 설계로 미세골절 대비 이점을 직접 제시하였다.", b: "표 B: MSC 43 vs 대조 57" },
      { m: "적은 표본 수·비무작위 설계·수술 전 자료 부재가 제한점이다.", b: "표 E: 비무작위, 수술 전 데이터 없음" }
    ],
    tableE: [
  ...
  /* ===================== 17. Medicina 2022 — Systematic Review & Meta-analysis ===================== */
  {
    ...
    tableC: [
      ...
      { v: "BMAC 비교 하위그룹", r: "임상·M-MOCART 유의차 없음", c: "BMAC", e: "hUCB-MSC와 동등", s: "임상 유의차 없음" }
    ],
    tableD: [
      { m: "통합 분석에서 hUCB-MSC 치료는 IKDC·WOMAC·VAS를 유의하게 개선하였고, 안전성과 재생 연골의 질이 확인되었다.", b: "표 C: IKDC MD −32.82, WOMAC 30.73, VAS 4.81 (모두 p<0.00001)" },
      { m: "BMAC과 비교 시 임상·M-MOCART 결과에 유의한 차이는 없었다.", b: "표 C: BMAC 비교 유의차 없음" },
      { m: "포함 연구의 이질성이 높고(I²≥93%) 무작위 대조연구가 부족하여 근거 강도에 제한이 있다.", b: "표 E: I² 93~98%, RCT 부족" }
    ],
    tableE: [
  ...
  /* ===================== 18. World J Clin Cases 2022 — patella case ===================== */
  {
    ...
    tableB: {
      ...
      followup: "단일 증례 경과 관찰"
    },
    tableC: [
      { v: "MRI 진단", r: "관절혈증, 내측 슬개대퇴인대 파열, 4.92 cm²(2.04×2.41 cm) 슬개골 연골 결손", c: "—(단일 증례)", e: "—", s: "관찰 소견" },
      { v: "이학적 소견", r: "부종 및 무릎 운동 제한", c: "—", e: "—", s: "관찰 소견" }
    ],
    tableD: [
      { m: "슬개골 탈구에 동반된 슬개골 연골 결손에 hUCB-MSC를 적용하여 슬개대퇴 구획 적용 가능성을 보인 증례이다.", b: "표 C: 슬개골 4.92 cm² 결손 치료" },
      { m: "단일 사례의 임상·영상 경과를 기술한 보고이다.", b: "표 B: n=1 증례" },
      { m: "효능의 일반화에는 제한이 있다.", b: "표 E: 단일 증례" }
    ],
    tableE: [
  ...
  /* ===================== 19. Medicina 2023 — UCB-MSC-HA + HTO n=12 ===================== */
  {
    ...
    tableC: [
      { v: "VAS 통증(수술 전→최종)", r: "61.6 → 11.4", c: "—(단일군, 수술 전 대비)", e: "50.2점 감소", s: "p<0.05" },
      { v: "WOMAC(수술 전→최종)", r: "46.6 → 12.3", c: "—", e: "34.3점 감소", s: "p<0.05" },
      { v: "하지 정렬(역학축)", r: "내반 6.7° → 외반 2.2°", c: "—", e: "정렬 교정", s: "—" },
      { v: "2차 관절경 ICRS-CRA(10명)", r: "grade I 10% / II 70% / III 20% (정상·거의 정상 80%)", c: "—", e: "모든 증례에서 재생 조직 관찰", s: "—" }
    ],
    tableD: [
      { m: "전층 연골 결손을 동반한 내측 구획 골관절염에서 HTO와 UCB-MSC-HA 복합체 병용으로 양호한 임상결과와 전례에서의 연골 회복을 얻었다.", b: "표 C: 임상 개선, 2차 관절경 80% 정상·거의 정상" },
      { m: "전층 연골 결손 환자에서 유효한 치료 선택지로 판단된다.", b: "표 C: 모든 증례에서 ICRS-CRA I~III" },
      { m: "후향적 설계·적은 표본 수·대조군 부재가 제한점이다.", b: "표 E: 후향적 설계, 적은 표본 수" }
    ],
    tableE: [
      { l: "후향적 연구이며 대조군 부재", i: "비교 효능 추론 제한", f: "해당 병용에 대한 보고가 드물어 대조 연구가 필요하다." },
  ...
  /* ===================== 20. Appl Health Econ Health Policy 2023 — cost-effectiveness ===================== */
  {
    ...
    tableD: [
      { m: "미세골절 대비 hUCB-MSC 치료는 비용효과적으로 평가되었다.", b: "표 C: ICER US$16,812/QALY(지불자), US$268/QALY(사회적)" },
      { m: "지불의사한계(US$22,367/QALY)에서 비용효과적일 확률은 지불자 관점 99%, 사회적 관점 100%였다.", b: "표 C: 확률적 민감도 분석" },
      { m: "한국 임상·비용 자료에 기반하여, 타국 적용 시 해석에 주의가 필요하다.", b: "표 E: 한국 자료 기반" }
    ],
    tableE: [
  ...
  /* ===================== 21. Arthrosc Orthop Sports Med 2023 — arthroscopic Cartistem + owHTO ===================== */
  {
    ...
    tableC: [
      { v: "KL 등급(수술 전·후)", r: "2명에서 III→II 개선", c: "—(단일군)", e: "골관절염 등급 호전", s: "—" },
      { v: "관절간격(JSD)", r: "3.75 mm → 4.63 mm", c: "—", e: "+0.88 mm 증가", s: "유의함" },
      { v: "해부학적 대퇴경골각(FTA)", r: "내반 2.46° → 외반 9.28°", c: "—", e: "정렬 교정", s: "—" },
      { v: "KSS / Lysholm", r: "46.63→70.50 / 43.5→75.5", c: "—", e: "+23.9 / +32.0점 개선", s: "유의함" },
      { v: "2차 관절경 ICRS", r: "모든 증례에서 등급 개선", c: "—", e: "연골 재생 확인", s: "—" }
    ],
    tableD: [
      { m: "KL II·III, ICRS IV 내측 구획 골관절염에서 내측 개방쐐기 HTO 중 관절경하 Cartistem® 연골성형술로 방사선·임상 결과가 유의하게 개선되었다.", b: "표 C: JSD 3.75→4.63 mm, KSS 46.63→70.50, Lysholm 43.5→75.5" },
      { m: "정렬 교정과 함께 2차 관절경상 전례에서 연골 등급이 향상되었다.", b: "표 C: FTA 내반2.46°→외반9.28°, 모든 증례에서 ICRS 개선" },
      { m: "8례의 후향적·비대조 연구로 예비적 결과이다.", b: "표 B/E: 8명, 생검 미시행" }
    ],
    tableE: [
  ...
  /* ===================== 22. Arthrosc Tech 2023 — Kelly clamp technique ===================== */
  {
    ...
    tableD: [
      { m: "Kelly clamp를 이용해 건식 관절경하 UCB-MSC 이식을 보다 간편하고 효과적으로 시행하는 술기이다.", b: "표 B: Kelly clamp 견인 술기" },
      { m: "관절경적 접근은 개방 관절절개보다 조기 회복과 반흔 감소의 이점이 있다.", b: "본문: 관절경의 이점" },
      { m: "정량적 임상 효능은 제시되지 않은 술기 보고이다.", b: "표 C: 효능 미보고" }
    ],
    tableE: [
  ...
  /* ===================== 23. Medicina 2023 — BMAC vs hUCB-MSC SR/meta ===================== */
  {
    ...
    tableC: [
      { v: "IKDC 개선(SMD)", r: "SMD 3.92 (95% CI 3.65~4.20)", c: "SMD 4.13 (95% CI 1.23~7.00)", e: "양군 모두 크게 개선·군간 동등", s: "군간 p=0.91" },
      { v: "WOMAC / KSS 통증 / KSS 기능", r: "hUCB-MSC", c: "BMAC", e: "군간 유의차 없음", s: "p=0.05 / 0.85 / 0.37" },
      { v: "2차 관절경 ICRS-CRA 등급", r: "더 우수", c: "기준(BMAC)", e: "hUCB-MSC 우월", s: "p<0.001" }
    ],
    tableD: [
      { m: "BMAC군과 hUCB-MSC군 모두 내반 무릎 골관절염에서 임상결과가 개선되었고, 군간 임상적 차이는 없었다.", b: "표 C: IKDC p=0.91, KSS 통증 p=0.85 등" },
      { m: "2차 관절경상 연골 재생은 hUCB-MSC군이 BMAC군보다 우수하였다.", b: "표 C: ICRS-CRA p<0.001" },
      { m: "포함 연구가 모두 근거수준 3~4의 후향 연구로 무작위 대조연구가 없다.", b: "표 E: RCT 부재, 후향 연구" }
    ],
    tableE: [
  ...
  /* ===================== 24. Orthop J Sports Med 2023 — UCB-MSC chondral defect n=85 ===================== */
  {
    ...
    design: "증례 시리즈", evidenceLabel: "후향적 증례 시리즈",
    ...
    tableD: [
      { m: "UCB-MSC 이식 후 단기 임상결과가 유의하게 개선되었다.", b: "표 C: 모든 PRO P<.001" },
      { m: "재생 연골의 비대(hypertrophy)가 관찰되었으나 그 정도는 임상결과와 상관이 없었다.", b: "표 C: 비대 등급-PRO 상관 없음" },
      { m: "대조군이 없는 증례 시리즈로 기존 술식과의 비교 효능은 판단하기 어렵다.", b: "표 E: 대조군 없는 증례 시리즈" }
    ],
    tableE: [
  ...
  /* ===================== 25. Knee Surg Relat Res 2024 — SR concurrent procedures ===================== */
  {
    ...
    tableD: [
      { m: "HTO는 병용 술식 유무와 무관하게 2차 관절경상 연골 재생과 임상 개선을 보였다.", b: "표 C: 전 술식군 ICRS 등급 개선" },
      { m: "병용 술식 중 hUCB-MSC군의 ICRS 등급 개선 범위(−2.46~−1.81)가 가장 컸다.", b: "표 C: 술식별 평균차 비교" },
      { m: "무작위 대조연구와 후속 메타분석이 없어 확정적 결론은 유보된다.", b: "표 E: RCT·정량 메타분석 필요" }
    ],
    tableE: [
  ...
  /* ===================== 26. Scientific Reports 2024 — hUCB-MSC vs microdrilling HTO ===================== */
  {
    ...
    tableC: [
      { v: "VAS·Lysholm·IKDC (군내, 6·12·24개월)", r: "유의 개선", c: "유의 개선", e: "양군 모두 개선", s: "군내 P<0.001" },
      { v: "VAS 통증 (24개월)", r: "15.21", c: "28.57", e: "hUCB-MSC 우월(통증 더 낮음)", s: "P=0.016" },
      { v: "IKDC (24개월)", r: "58.54", c: "50.29", e: "hUCB-MSC 우월(기능 더 높음)", s: "P=0.038" },
      { v: "MOCART 2.0 (1년, MRI)", r: "53.7 ± 9.07", c: "53.04 ± 14.49", e: "군간 차이 없음", s: "p=0.8" },
      { v: "결손 부위별 하위분석", r: "전방 병변에서 우월한 치유", c: "미세천공(microdrilling)", e: "hUCB-MSC 우월", s: "—" }
    ],
    tableD: [
      { m: "내측 골관절염에서 hUCB-MSC군과 미세천공군 모두 유효하였으며, 환자보고결과와 연골 재생은 hUCB-MSC군이 우수하였다.", b: "표 C: 24개월 임상 우월, 12개월 관절경 치유 우월" },
      { m: "특히 전방 병변에서 hUCB-MSC군의 연골 치유가 우수하였다.", b: "표 C: 부위별 하위분석" },
      { m: "적은 표본 수·후향적 설계·조직학 평가 부재가 제한점이다.", b: "표 E: 후향적 설계, 적은 표본 수, 조직학 평가 없음" }
    ],
    tableE: [
  ...
  /* ===================== 27. KSSTA 2024 — hyaline-type cartilage prospective ===================== */
  {
    ...
    design: "전향적 비교 코호트 연구", evidenceLabel: "전향적 비교 코호트 연구",
    ...
    tableC: [
      ...
      { v: "2형 콜라겐 중등~강 양성 비율", r: "93.3%", c: "60%", e: "hUCB-MSC 우월", s: "유의함" },
      { v: "탐침 시 정상 연골 유사 경도", r: "86.7%", c: "50.0%", e: "hUCB-MSC가 더 단단", s: "p=0.075" },
      { v: "유리연골 비율(조직학)", r: "더 높음", c: "기준(미세천공)", e: "hUCB-MSC 우월", s: "p=0.041" },
      { v: "임상결과(VAS·IKDC)", r: "개선", c: "개선", e: "군간 유의차 없음", s: "유의차 없음" }
    ],
    tableD: [
      { m: "결손이 더 컸음에도 hUCB-MSC군의 임상결과는 미세천공군과 대등하였다.", b: "표 C: 결손 7.2 vs 5.2 cm²(p=0.023), 임상 군간 차이 없음" },
      { m: "hUCB-MSC군은 미세천공군보다 유리연골형(제2형 콜라겐) 재생이 많았다.", b: "표 C: 2형 콜라겐 93.3% vs 60%, 유리연골 p=0.041" },
      { m: "적은 표본 수와 대조군 추적 소실(5례)로 제2종 오류 위험이 있다.", b: "표 E: 적은 표본 수, 대조군 5명 추적 소실" }
    ],
    tableE: [
  ...
  /* ===================== 29. Orthop Traumatol Surg Res 2025 — meniscus status ===================== */
  {
    ...
    tableC: [
      { v: "수술 전 IKDC / WOMAC(기저)", r: "그룹 P 52.3 / 45.6", c: "그룹 L 48.7 / 47.2", e: "기저 동등", s: "p=0.30 / 0.39" },
      { v: "IKDC·WOMAC(군내 개선)", r: "유의 개선(그룹 P)", c: "유의 개선(그룹 L)", e: "양군 모두 개선", s: "군내 p<0.01" },
      { v: "IKDC / WOMAC(최종, 군간)", r: "그룹 P", c: "그룹 L", e: "군간 차이 없음", s: "p=0.21 / 0.42" },
      { v: "MOCART 2.0 / ICRS-CRA(군간)", r: "그룹 P", c: "그룹 L", e: "군간 차이 없음", s: "p=0.35 / 0.08" },
    ...
    tableD: [
      { m: "HTO와 hUCB-MSC 병용은 수술 전 내측 반월상연골 상태와 무관하게 유의한 임상 개선과 연골 재생을 보였다.", b: "표 C: 양군 IKDC·WOMAC p<0.01, 군간 차이 없음" },
      { m: "수술 전 내측 반월상연골 탈출은 연골하골 변화와 연관되어, 장기 결과에서 반월상연골 상태 고려가 필요하다.", b: "표 C: MM 탈출 상관 r=−0.24·−0.29(p=0.03·0.02)" },
      { m: "후향적 비교 설계와 적은 표본 수에 따른 선택 편향이 제한점이다.", b: "표 E: 후향, 선택 편향" }
    ],
    tableE: [
  ...
  /* ===================== 30. Stem Cell Res Ther 2025 — HTO + hUCB-MSC-HA n=10 ===================== */
  {
    ...
    tableC: [
      { v: "WOMAC(수술 전→2년)", r: "57.00 → 27.50", c: "—(단일군, 수술 전 대비)", e: "29.5점 감소(개선)", s: "p=0.002" },
      { v: "VAS(수술 전→2년)", r: "66.25 → 26.25", c: "—", e: "40.0점 감소(개선)", s: "p=0.002" },
      { v: "SF-36 PCS / MCS(삶의 질)", r: "27.97→55.31 / 41.04→63.18", c: "—", e: "신체·정신 영역 모두 향상", s: "p=0.002 / 0.020" },
      { v: "MFC 연골 병변(크기·ICRS)", r: "병변 크기·ICRS 등급 호전", c: "—", e: "연골 상태 개선", s: "유의함" }
    ],
    tableD: [
      { m: "중년의 중증 골관절염에서 HTO와 hUCB-MSC-HA 복합체 병용으로 2년간 통증·기능·삶의 질이 유의하게 개선되었다.", b: "표 C: WOMAC·VAS·SF-36 p=0.002~0.020" },
      { m: "금속물 제거 시 평가에서 내측 대퇴과 연골 병변(크기·ICRS)이 유의하게 호전되었다.", b: "표 C: MFC 연골 개선" },
      { m: "적은 표본 수의 증례 시리즈이며 추적 기간이 짧은 것이 제한점이다.", b: "표 E: 적은 표본 수, 짧은 추적 기간" }
    ],
    tableE: [
  ...
  /* ===================== Related: Lateral OA return to sports ===================== */
  {
    ...
    tableB: {
      ...
      followup: "후향적 검토(1년 및 최종 추적)"
    },
    tableC: [
      { v: "스포츠 복귀(원하는 수준)", r: "67% (전원 일부 스포츠 복귀 가능)", c: "—(단일군)", e: "—", s: "—" },
      { v: "직장 복귀(직무 강도)", r: "90.5%", c: "—", e: "—", s: "—" },
      { v: "Lysholm / IKDC / Tegner(수술 전→최종)", r: "58.3→84.3 / 53.9→78.0 / 4.0→5.1", c: "—", e: "유의 개선", s: "p<0.001" },
      { v: "관절간격(JSW, 수술 전→최종)", r: "0.8 → 2.3 mm", c: "—", e: "증가", s: "—" },
      { v: "치료 만족도", r: "76.2% 매우/대체로 만족", c: "—", e: "—", s: "—" }
    ],
    tableD: [
      { m: "진행성 외측 골관절염 환자에서 신연 관절성형술·외측 반월상연골 동종이식·연골 회복술 병용으로 임상·방사선 개선과 스포츠·직장 복귀를 얻었다.", b: "표 B/C: 21명 대부분 RTS·RTW" },
      { m: "CARTISTEM 자체를 평가한 연구는 아니며, 외측 구획 연골 보존 전략의 참고 근거이다.", b: "표 A: 관련 연구(연골 회복술 병용)" },
      { m: "후향적 설계와 적은 표본 수로 일반화에 제한이 있다.", b: "표 E: 후향, n=21" }
    ],
    tableE: [
  ...
  /* ===================== Reference: MRI underestimates grade ===================== */
  {
    ...
    tableD: [
      { m: "무릎 MRI는 관절경 소견에 비해 연골 병변 등급을 과소평가하는 경향이 있었다.", b: "제목·표 C: MRI 과소추정" },
      { m: "CARTISTEM 연구에서 영상 평가의 한계(MRI 과소평가)를 뒷받침하는 방법론적 참고 문헌이다.", b: "표 A: 방법론 참고문헌" },
      { m: "치료 효능 연구가 아니므로 효능 판단에는 사용하지 않는다.", b: "표 A: 진단정확도 연구" }
    ],
    tableE: [
  ...
  /* ===================== Reference: Arthroscopic measurement of cartilage lesions ===================== */
  {
    ...
    tableD: [
      { m: "연골 병변의 깊이·크기 측정은 치료 결정과 예후에 필수적이며, 변연절제 후 관절경 측정이 크기 기준으로 활용된다.", b: "표 C: 변연절제 후 크기 기준화" },
      { m: "CARTISTEM 연구에서 병변 크기 측정(변연절제 후 기준)의 방법론적 참고 문헌이다.", b: "표 A: 방법론 참고문헌" },
      { m: "치료 효능 연구가 아니므로 효능 판단에는 사용하지 않는다.", b: "표 A: 측정 방법론" }
    ],
    tableE: [
