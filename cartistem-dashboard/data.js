...
window.CARTISTEM_META = {
  ...
  synthesis: [
    ...
    "다수 연구가 후향적·소표본·대조군 부재의 한계를 공유하며, 저자들은 대규모 무작위 대조시험과 장기 추적의 필요성을 일관되게 제언한다."
  ]
};
...
window.PAPERS = [
  /* ===================== 1. CARTISTEM Phase 3 RCT ===================== */
  {
    ...
    design: "다기관 무작위 대조 3상 시험 + 5년 관찰 연장 추적", evidenceLabel: "근거수준 1 (RCT)",
    ...
    tableB: {
      ...
      outcomes: "1차: 48주 관절경상 ICRS 거시적 연골회복평가(맹검) 1등급 이상 개선 비율. 2차: 조직학적 평가, VAS·WOMAC·IKDC 변화, 이상반응",
    ...
    tableD: [
      ...
      { m: "근거수준 1의 다기관 무작위 대조시험으로 비교적 높은 신뢰도를 제공한다", b: "표 B: RCT, 10개 병원, 114명 무작위 배정" }
    ],
    tableE: [
      ...
      { l: "고령·큰 결손 집단 대상", i: "젊은 환자·소결손으로 일반화 제약", f: "다양한 환자군에서 추가 검증" }
    ]
  },
  ...
  /* ===================== 2. Stem Cells Transl Med (first-in-human, 7yr) ===================== */
  {
    ...
    design: "최초 인체적용 1/2상 임상시험(안전성·개념증명), 단일군, 7년 연장 추적", evidenceLabel: "근거수준 하위 (단일군 임상시험)",
    ...
    tableD: [
      ...
      { m: "표본 7명·단일군의 초기 임상시험으로 효능은 개념증명 수준이다", b: "표 E: 소표본·대조군 부재" }
    ],
    tableE: [
  ...
  /* ===================== 3. BMC Musculoskeletal Disorders — case report 5yr ===================== */
  {
    ...
    design: "증례 보고(1례), 5년 추적", evidenceLabel: "근거수준 하위 (증례 보고)",
  ...
  /* ===================== 4. The Knee 2019 — DFO + hUCB-MSC (2 cases) ===================== */
  {
    ...
    design: "증례 보고(2례)", evidenceLabel: "근거수준 하위 (증례 보고)",
  ...
  /* ===================== 5. World J Stem Cells 2020 — HTO + hUCB-MSC n=125 ===================== */
  {
    ...
    design: "후향적 연구(증례 시리즈), 대조군 없음", evidenceLabel: "근거수준 하위 (후향, LoE 4)",
    ...
    tableD: [
      ...
      { m: "후향적·대조군 부재로 비교 효능은 입증되지 않는다", b: "표 E: 후향, 대조군 없음" }
    ],
    tableE: [
  ...
  /* ===================== 6. Regenerative Therapy 2020 — n=128 2yr ===================== */
  {
    ...
    design: "증례 시리즈(후향), 대조군 없음", evidenceLabel: "근거수준 하위 (LoE 4)",
  ...
  /* ===================== 7. Arch Orthop Trauma Surg 2020 — >60yr n=25 ===================== */
  {
    ...
    design: "증례 시리즈(후향)", evidenceLabel: "근거수준 하위 (LoE 4)",
    pmid: "31980879", reg: "—", impact: "IF 1.97",
    tableB: {
      question: "60세 이상 내측 구획(MC) 골관절염에서 hUCB-MSC 이식 후 임상결과",
      population: "60세 초과, MC kissing 병변, MFC 전층 결손 ≥4 cm², 내반변형 ≥3°. 25명(평균 64.9±4.4세, 평균 MFC 결손 7.2±1.9 cm²)",
      intervention: "Na-hyaluronate + hUCB-MSC 혼합 이식 + 전 예 HTO",
  ...
  /* ===================== 8. J Clin Orthop Trauma 2019 — juvenile OCD (2 cases) ===================== */
  {
    ...
    design: "증례 시리즈(2례)", evidenceLabel: "근거수준 하위 (증례 시리즈)",
  ...
  /* ===================== 9 & 12. Int Orthop 2021 — HTO + hUCB-MSC n=93 ===================== */
  {
    ...
    design: "후향적 연구(전향적 추적), 대조군 없음", evidenceLabel: "근거수준 중간 (후향 코호트)",
    ...
    tableC: [
      ...
      { v: "2차 관절경 ICRS-CRA(49명)", r: "grade I 8.2%, II 69.3%, III 22.5%", c: "수술 전 전 예 grade IV", e: "—", s: "p<0.05" },
    ...
    tableD: [
      ...
      { m: "2차 관절경에서 전 예 ICRS IV였던 연골이 등급 호전을 보였다", b: "표 C: ICRS-CRA I~III로 호전" },
      { m: "대조군 부재로 실제 효과·적응증은 RCT로 규명 필요하다", b: "표 E: 대조군 없음, 추적 짧음" }
    ],
    tableE: [
      { l: "후향적·HTO 단독 대조군 부재", i: "연골 재생 우월성 입증 제한", f: "대조군 포함 무작위 대조시험 필요(저자 명시)" },
  ...
  /* ===================== 10. Cell Transplantation 2020 — BMAC vs hUCB-MSC ===================== */
  {
    ...
    design: "후향적 비교 연구", evidenceLabel: "근거수준 중간 (후향 비교)",
    ...
    tableD: [
      ...
      { m: "소표본·후향 설계로 장기·대규모 검증이 필요하다", b: "표 E: 소표본, 후향" }
    ],
    tableE: [
      { l: "소표본·후향, 장기 추적 부재", i: "결과의 일반화·장기 효과 입증 제한", f: "대규모·잘 통제된 전향 설계·장기 추적 필요" }
    ]
  },
  ...
  /* ===================== 11. Arthroscopy 2021 — BMAC vs hUCB-MSC HTO+MFX ===================== */
  {
    ...
    tableB: {
      ...
      population: "HTO+MFX + BMAC/hUCB-MSC 150예 중 kissing 병변·2차 관절경 충족: BMAC 42예, hUCB-MSC 32예. 평균 추적 18.7±4.6개월",
    ...
    tableD: [
      ...
      { m: "소표본·후향 설계가 근거 수준을 제한한다", b: "표 E: 소표본, 후향" }
    ],
    tableE: [
  ...
  /* ===================== 13. KSSTA 2022 — BMAC vs hUCB-MSC PS-matched ===================== */
  {
    ...
    design: "후향적 코호트(성향점수 매칭)", evidenceLabel: "근거수준 중간 (후향, PS 매칭)",
  ...
  /* ===================== 14. Arthroscopy Techniques 2021 — dry arthroscopy technique ===================== */
  {
    ...
    design: "기술 노트(수술 술기)", evidenceLabel: "근거수준 맥락 의존 (술기)",
    ...
    tableD: [
      ...
      { m: "관절경 접근은 개방 관절절개 대비 조기 가동·반흔 감소 이점이 있다", b: "본문: 관절경의 회복·반흔 이점" },
  ...
  /* ===================== 15. J Cartilage Joint Preservation 2022 — US phase 1/2a ===================== */
  {
    ...
    design: "개방표지 비무작위 1/2a상 임상시험(미국)", evidenceLabel: "근거수준 하위 (단일군 1/2a상)",
    ...
    tableC: [
      ...
      { v: "치료관련 TEAE", r: "7명(58%)에서 10건; 중단·중대이상반응·사망 0건", c: "—", e: "—", s: "안전성" },
    ...
    tableD: [
      { m: "미국 ICRS 3~4 환자에서 hUCB-MSC-4%HA 복합체 이식은 24개월간 안전하다", b: "표 C: 중대이상반응·사망·DLT 0건, MTD 2.0×10⁷" },
      { m: "기능·통증이 개선되고 MRI 이상 소견이 감소하여 연골 회복 근거를 보인다", b: "표 C: IKDC 12·24개월 유의 개선, MRI 이상 91.7→16.7%" },
      { m: "소표본·개방표지·대조군 부재로 효능은 예비적이다", b: "표 E: 1/2상의 본질적 한계" }
    ],
    tableE: [
      { l: "소표본·개방표지·대조군 부재(1/2상 특성)", i: "효능 결과는 예비적", f: "한국 3상 데이터가 유사 이익을 시사 — 추가 검증의 기반 형성" }
    ]
  },
  ...
  /* ===================== 16. The Knee 2021 — hUCB-MSC+HTO vs MFx+HTO ===================== */
  {
    ...
    design: "비무작위 비교 연구", evidenceLabel: "근거수준 중간 (비무작위 비교)",
    ...
    tableD: [
      ...
      { m: "소표본·비무작위·수술 전 임상자료 부재가 근거를 제한한다", b: "표 E: 비무작위, 수술 전 데이터 없음" }
    ],
    tableE: [
      { l: "소표본·비무작위", i: "선택 편향 가능", f: "무작위 전향 연구 필요" },
      { l: "추적 짧음·수술 전 임상자료 부재·연골재생 상세자료(MRI·2차 관절경) 부재", i: "연골 재생 직접 평가 제한", f: "영상·2차 관절경 포함 연구 필요" }
    ]
  },
  ...
  /* ===================== 17. Medicina 2022 — Systematic Review & Meta-analysis ===================== */
  {
    ...
    design: "체계적 문헌고찰 및 메타분석(PRISMA)", evidenceLabel: "근거수준 최상위 (SR/메타분석)",
  ...
  /* ===================== 18. World J Clin Cases 2022 — patella case ===================== */
  {
    ...
    design: "증례 보고(1례)", evidenceLabel: "근거수준 하위 (증례 보고)",
  ...
  /* ===================== 19. Medicina 2023 — UCB-MSC-HA + HTO n=12 ===================== */
  {
    ...
    design: "후향적 증례 시리즈, 대조군 없음", evidenceLabel: "근거수준 하위 (후향 증례 시리즈)",
    ...
    tableC: [
      ...
      { v: "2차 관절경 ICRS-CRA(10명)", r: "grade I 10% / II 70% / III 20% (정상·거의 정상 80%)", c: "—", e: "전 예 재생 조직 관찰", s: "—" }
    ],
    tableD: [
      { m: "HTO + UCB-MSC-HA 복합체는 전층 연골 결손 동반 내측 무릎 OA에서 양호한 임상결과와 전 예 연골 회복을 보인다", b: "표 C: 임상 개선, 2차 관절경 80% 정상·거의 정상" },
      { m: "전층 연골 결손 환자의 좋은 치료 옵션이 될 수 있다", b: "표 C: ICRS-CRA I~III 전 예" },
      { m: "후향·소표본·대조군 부재가 근거를 제한한다", b: "표 E: 후향, 소표본" }
    ],
    tableE: [
      { l: "후향적·대조군 부재", i: "비교 효능 추론 제한", f: "(해당 병용 보고 드묾) 대조 연구 필요" },
      { l: "소표본(n=12)", i: "검정력 제한", f: "더 큰 표본 연구 필요" }
    ]
  },
  ...
  /* ===================== 20. Appl Health Econ Health Policy 2023 — cost-effectiveness ===================== */
  {
    ...
    design: "비용효과 분석(분할생존 모형)", evidenceLabel: "근거수준 맥락 의존 (경제성 모형)",
  ...
  /* ===================== 21. Arthrosc Orthop Sports Med 2023 — arthroscopic Cartistem + owHTO ===================== */
  {
    ...
    design: "후향적 연구(증례 시리즈)", evidenceLabel: "근거수준 하위 (후향 증례 시리즈)",
    pmid: "—", reg: "—", impact: "—",
    tableB: {
    ...
    tableC: [
      ...
      { v: "2차 관절경 ICRS", r: "전 예 유의 개선", c: "—", e: "—", s: "—" }
    ],
    tableD: [
      ...
      { m: "정렬 교정과 함께 2차 관절경상 전 예 연골 등급이 개선되었다", b: "표 C: FTA 내반2.46°→외반9.28°, ICRS 전 예 개선" },
      { m: "소표본(8명)·후향·대조군 부재로 근거는 예비적이다", b: "표 B/E: 8명, 생검 미시행" }
    ],
    tableE: [
  ...
  /* ===================== 22. Arthrosc Tech 2023 — Kelly clamp technique ===================== */
  {
    ...
    tableD: [
      ...
      { m: "관절경 접근은 개방 관절절개보다 조기 회복·반흔 감소 이점이 있다", b: "본문: 관절경의 이점" },
  ...
  /* ===================== 23. Medicina 2023 — BMAC vs hUCB-MSC SR/meta ===================== */
  {
    ...
    tableD: [
      ...
      { m: "포함 연구가 모두 LoE 3~4 후향으로 RCT가 부재하다", b: "표 E: RCT 부재, 후향 연구" }
    ],
    tableE: [
      { l: "포함 연구가 LoE 3~4 후향적 성격, RCT·전향 비교 연구 부재", i: "교란 통제·근거 강도 제한", f: "더 높은 검정력의 RCT 필요" }
    ]
  },
  ...
  /* ===================== 24. Orthop J Sports Med 2023 — UCB-MSC chondral defect n=85 ===================== */
  {
    ...
    design: "증례 시리즈", evidenceLabel: "근거수준 하위 (LoE 4)",
    ...
    tableD: [
      ...
      { m: "증례 시리즈(LoE 4)·대조군 부재로 비교 효능 추론은 제한된다", b: "표 E: LoE 4" }
    ],
    tableE: [
  ...
  /* ===================== 25. Knee Surg Relat Res 2024 — SR concurrent procedures ===================== */
  {
    ...
    design: "체계적 문헌고찰(PRISMA)", evidenceLabel: "근거수준 최상위 (체계적 문헌고찰)",
  ...
  /* ===================== 26. Scientific Reports 2024 — hUCB-MSC vs microdrilling HTO ===================== */
  {
    ...
    tableD: [
      ...
      { m: "소표본·후향·조직학 평가 부재가 근거를 제한한다", b: "표 E: 후향, 소표본, 조직학 없음" }
    ],
    tableE: [
      { l: "후향적·소표본", i: "통계적 검정력 제한", f: "대규모 잘 설계된 전향 무작위 시험 필요" },
  ...
  /* ===================== 27. KSSTA 2024 — hyaline-type cartilage prospective ===================== */
  {
    ...
    design: "전향적 비교 코호트 연구", evidenceLabel: "근거수준 중간 (전향 비교, LoE II)",
    ...
    tableD: [
      ...
      { m: "소표본·대조군 추적소실(5명)이 2종 오류 위험을 높인다", b: "표 E: 소표본, 대조군 5명 소실" }
    ],
    tableE: [
      { l: "표본 크기가 작음(생검 동의 확보·연구기간 우려로 최소화)", i: "주요 한계, 검정력 제한", f: "더 큰 표본 연구 필요" },
      { l: "대조군 5명 추적 소실", i: "2종 오류(Type II) 위험 증가", f: "추적 유지 강화 필요" }
    ]
  },
  ...
  /* ===================== 29. Orthop Traumatol Surg Res 2025 — meniscus status ===================== */
  {
    ...
    design: "후향적 비교 연구", evidenceLabel: "근거수준 중간 (후향 비교, LoE III)",
    ...
    tableC: [
      ...
      { v: "양호 결과 비율(아연골 변화·ICRS I/II)", r: "그룹 P 56% / 84%", c: "그룹 L 31.8% / 72.7%", e: "유의하진 않음", s: "p=0.09 / p=0.48" },
      { v: "수술 전 MM 탈출 상관", r: "MOCART 2.0 r=−0.24 / 아연골 변화 r=−0.29", c: "—", e: "음의 상관", s: "p=0.03 / p=0.02" }
    ],
    tableD: [
      { m: "HTO + hUCB-MSC는 수술 전 MM 상태와 무관하게 유의한 임상 개선과 연골 재생을 제공한다", b: "표 C: 양군 IKDC·WOMAC p<0.01, 군간 차이 없음" },
      { m: "수술 전 MM 탈출은 아연골골 변화에 영향을 미쳐 장기 결과에서 MM 상태 고려가 필요하다", b: "표 C: MM 탈출 상관 r=−0.24·−0.29(p=0.03·0.02)" },
      { m: "후향적 비교(LoE III)·소표본의 선택 편향이 존재한다", b: "표 E: 후향, 선택 편향" }
    ],
    tableE: [
  ...
  /* ===================== 30. Stem Cell Res Ther 2025 — HTO + hUCB-MSC-HA n=10 ===================== */
  {
    ...
    design: "증례 시리즈", evidenceLabel: "근거수준 하위 (증례 시리즈)",
    ...
    tableD: [
      ...
      { m: "소표본 증례 시리즈·짧은 추적이 근거를 제한한다", b: "표 E: 소표본, 단기 추적" }
    ],
    tableE: [
      { l: "비교적 짧은 추적·소표본(n=10) 증례 시리즈", i: "장기 효과·일반화 제한", f: "장기 추적·대조 연구 필요" }
    ]
  },
  ...
  /* ===================== Related: Lateral OA return to sports ===================== */
  {
    ...
    journal: "Knee Surgery, Sports Traumatology, Arthroscopy", year: 2022,
    design: "후향적 비교 연구", evidenceLabel: "근거수준 중간 (관련 연구·후향)",
    pmid: "—", reg: "—", impact: "—",
    tableB: {
    ...
    tableD: [
      ...
      { m: "후향·소표본으로 일반화는 제한된다", b: "표 E: 후향, n=21" }
    ],
    tableE: [
      { l: "후향적·소표본(n=21), 연골 회복술 세부(세포원) 혼재", i: "CARTISTEM 단독 효과 분리 불가", f: "구획·술식별 비교 연구 필요" }
    ]
  },
  ...
  /* ===================== Reference: MRI underestimates grade ===================== */
  {
    ...
    design: "진단정확도 비교 연구(MRI vs 관절경)", evidenceLabel: "근거수준 맥락 의존 (방법론 참고)",
    pmid: "—", reg: "—", impact: "—",
    tableB: {
  ...
  /* ===================== Reference: Arthroscopic measurement of cartilage lesions ===================== */
  {
    ...
    design: "방법론(측정) 연구", evidenceLabel: "근거수준 맥락 의존 (방법론 참고)",
    pmid: "—", reg: "—", impact: "—",
    tableB: {
