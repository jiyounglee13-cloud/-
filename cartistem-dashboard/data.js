...
window.CARTISTEM_META = {
  ...
  synthesis: [
    ...
    "고위경골절골술(HTO) 병용 연구들(Seon·Song·Park·Kim 등)에서 IKDC·WOMAC·VAS가 일관되게 유의 개선되었다. 예컨대 Int Orthop 2021(n=93)에서 IKDC 중앙값이 39.0→71.3, WOMAC 44.5→11.0으로 호전되었고, 2차 관절경상 수술 전 전 증례 ICRS IV였던 연골의 등급이 호전되었다.",
    "골수흡인농축물(BMAC)과 직접 비교한 연구들(Cell Transplantation 2020, Arthroscopy 2021, KSSTA 2022, 메타분석 2023)에서 임상결과는 양군이 유사했으나(메타분석 IKDC SMD 3.92 vs 4.13, p=0.91), 2차 관절경상 연골 재생 등급은 hUCB-MSC가 더 우수한 경향이 반복 관찰되었다(KSSTA 2022 p=0.040, 메타분석 p<0.001).",
    "미세천공·미세골절과 비교한 연구에서 hUCB-MSC가 우월했다. Scientific Reports 2024에서는 24개월 VAS 15.21 대 28.57(P=0.016)·IKDC 58.54 대 50.29(P=0.038), KSSTA 2024에서는 유리연골형 지표인 제2형 콜라겐 양성 비율 93.3% 대 60%(p=0.041)로 보고되었다.",
...
window.PAPERS = [
  /* ===================== 1. CARTISTEM Phase 3 RCT ===================== */
  {
    ...
    tableD: [
      ...
      { m: "10개 기관에서 114명을 무작위 배정한 다기관 무작위 대조시험으로, 미세골절과의 직접 비교 근거를 제시한다", b: "표 B: RCT, 10개 병원, 114명 무작위 배정" }
    ],
    tableE: [
  ...
  /* ===================== 24. Orthop J Sports Med 2023 — UCB-MSC chondral defect n=85 ===================== */
  {
    ...
    tableD: [
      ...
      { m: "대조군이 없는 증례 시리즈여서 미세골절 등 기존 술식과의 비교 효능은 추론하기 어렵다", b: "표 E: 대조군 없는 증례 시리즈" }
    ],
    tableE: [
  ...
  /* ===================== 29. Orthop Traumatol Surg Res 2025 — meniscus status ===================== */
  {
    ...
    tableD: [
      ...
      { m: "후향적 비교 설계와 적은 표본 수에 따른 선택 편향이 존재한다", b: "표 E: 후향, 선택 편향" }
    ],
    tableE: [
